...
```bash
$ clojure -Ttools install io.github.clj-holmes/clj-watson '{:git/tag "v3.0.0" :git/sha "47d3321"}' :as clj-watson
...
```bash
$ clojure -Sdeps '{:deps {io.github.clj-holmes/clj-watson {:git/tag "v3.0.0" :git/sha "47d3321"}}}' -M -m clj-watson.cli scan -p deps.edn
```
Or you can just add it to your project `deps.edn`
```clojure
{:deps {}
 :aliases
 {:clj-watson {:extra-deps {io.github.clj-holmes/clj-watson {:git/tag "v3.0.0" :git/sha "47d3321"}}
